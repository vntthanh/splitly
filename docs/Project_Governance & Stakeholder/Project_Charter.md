...
| **Date**                          | 15 July 2026                                                                                                                                                               |
| **Organizational Sponsor**        | Naver                                                                                                                                                                      |
| **Project Manager / Team Leader** | Nguyễn Hiền Tuấn Anh                                                                                                                                                       |
...
Splitly differentiates itself through three bill-splitting methods, group and bill-level debt visibility, Gemini 3.1 Flash Light receipt extraction, VietQR payment assistance, a payment declaration–confirmation process, reminders, and essential notifications.
...
- Deliver a measurable project aligned with Naver sponsorship while using Gemini 3.1 Flash Light as the approved receipt-extraction provider.
...
| O3 – AI receipt input               | Use Gemini 3.1 Flash Light to read supported receipt images, return structured data, and prefill an editable draft. | A proposed target of at least 85% of critical fields is evaluated on the PO-approved UAT set; the measured baseline is reported, and failures always offer retry or manual entry. |
...
- JPG/JPEG, PNG, or WebP receipt images up to 10 MB processed through Gemini 3.1 Flash Light, with structured extraction and mandatory user review/correction before bill creation.
...
| D4  | External integrations    | Gemini 3.1 Flash Light receipt extraction, VietQR images/instructions, SMTP/email, Vercel, Render, and MongoDB Atlas with appropriate fallbacks.                      |
...
| M3  | Gemini receipt integration complete                      | Weeks 5–6       | Gemini 3.1 Flash Light runs end to end; supported image validation, receipt test set, manual correction, and fallback are tested. |
...
| ----------------------------- | --------------------------------------------------------------- | ------------------------------------------------------------------------- |
| Project Sponsor               | Naver                                                           | Approval, sponsorship, escalation, go/no-go                               |
| Project Manager / Team Leader | Nguyễn Hiền Tuấn Anh                                            | Value, scope, plan, stakeholders, acceptance                              |
...
| AI provider                   | Google Gemini 3.1 Flash Light API                               | Multimodal receipt API, quota, terms, and availability                    |
...
| A3  | The team obtains a Gemini 3.1 Flash Light API key, image-capable access, quota, and terms suitable for development and UAT.                         |
...
| ---------------------------- | -------------------- | -------- | --------- | ---- |
| Project Sponsor              | Naver                | Approved |           |      |
| Project Manager/ Team Leader | Nguyễn Hiền Tuấn Anh | Approved |           |      |
| Development                  | Members              | Approved |           |      |
